...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(RST_N, CLK, EN, count)
/* synthesis syn_black_box black_box_pad_pin="RST_N,CLK,EN,count[31:0]" */;
  input RST_N;
  input CLK;
  input EN;
  output [31:0]count;
