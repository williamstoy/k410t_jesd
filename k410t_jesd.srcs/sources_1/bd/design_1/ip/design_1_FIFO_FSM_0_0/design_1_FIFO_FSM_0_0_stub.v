...
module design_1_FIFO_FSM_0_0(RST_N, CLK, TEST_MODE, AVG, test_data, inA0, inA1, 
  inB0, inB1, FIFO_DATA, data_count, pad_out, channelA_out, channelB_out)
/* synthesis syn_black_box black_box_pad_pin="RST_N,CLK,TEST_MODE,AVG,test_data[31:0],inA0[13:0],inA1[13:0],inB0[13:0],inB1[13:0],FIFO_DATA[31:0],data_count,pad_out[31:0],channelA_out[13:0],channelB_out[13:0]" */;
  input RST_N;
  input CLK;
  input TEST_MODE;
  input AVG;
