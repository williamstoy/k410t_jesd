...
architecture STRUCTURE of design_1_enabled_binary_count_0_0_enabled_binary_counter is
  ...
  attribute SOFT_HLUTNM of \blockstrobe_detect[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \blockstrobe_detect[1]_i_1\ : label is "soft_lutpair0";
begin
  count(31 downto 0) <= \^count\(31 downto 0);
\blockstrobe_detect[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FB08"
    )
        port map (
...
\blockstrobe_detect[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FB08"
    )
        port map (
...
\count[11]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02FF0200"
    )
        port map (
...
\count[11]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02FF0200"
    )
        port map (
...
\count[19]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02FF0200"
    )
        port map (
...
\count[19]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02FF0200"
    )
        port map (
...
\count[19]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02FF0200"
    )
        port map (
...
\count[19]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02FF0200"
    )
        port map (
...
\count[23]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02FF0200"
    )
        port map (
...
\count[27]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02FF0200"
    )
        port map (
...
\count[27]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02FF0200"
    )
        port map (
...
\count[27]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02FF0200"
    )
        port map (
...
\count[27]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02FF0200"
    )
        port map (
...
\count_reg[31]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \count[31]_i_4_n_0\,
      S(2) => \count[31]_i_5_n_0\,
      S(1) => \count[31]_i_6_n_0\,
      S(0) => \count[31]_i_7_n_0\
    );
